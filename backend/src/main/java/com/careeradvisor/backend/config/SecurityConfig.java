    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/", "/auth/health", "/api/auth/**", "/auth/**").permitAll()
                        ...
                        .requestMatchers("/api/skills/**", "/api/progress/**", "/api/quiz/latest", "/api/recommendations/**", "/api/interviews/**", "/api/resumes/**").authenticated()
